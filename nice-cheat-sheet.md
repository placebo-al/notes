...
-   File Inclusion Vulnerabilities 
    ...
    -   For a Remote File Inclusion look for php code that is not  sanitised and passed to the PHP include function and the php.ini
...
-   <span id="_mgu7e3u7svak" class="anchor"><span id="_Toc480741820" class="anchor"></span></span>Database Vulnerabilities
    ...
    -   Detecting SQL Injection Vulnerabilities. 
         ...
         Most modern automated scanner tools use time delay techniques to detect SQL injection vulnerabilities.  This method can tell you if a SQL injection vulnerability is present even if it is a "blind" sql injection vulnerability that does not provide any data back.  You know your SQL injection is working when the server takes a Looooong time to respond.  I have added a line comment at the end of each injection statement just in case there is additional SQL code after the injection point.
...
-   Password Attacks
    ...
    -   Mimikatz
        ...
        -   extract plaintext passwords, hash, PIN code and kerberos
